...
public class MainController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        int id, pos;
        if (ses.getAttribute("prod") == null) {
            ArrayList<Producto> almacenaux = new ArrayList<Producto>();
            ses.setAttribute("prod", almacenaux);
        }
        ArrayList<Producto> listaalmacen = (ArrayList<Producto>) ses.getAttribute("prod");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        HttpSession ses = request.getSession();
        ArrayList<Producto> lista = (ArrayList<Producto>) ses.getAttribute("prod");
        idt = obj1.getId();
        if (idt == 0) {
